package com.techamove.view.BusinessCardShare;
...
import com.techamove.view.BusinessCardSave.SaveCardAdapter;
...
public class ShareCardActivity extends BaseActivity implements ResponseListener {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mContext = ShareCardActivity.this;
    ...
    private void iniview() {
        ...
        txtTitle.setText(mContext.getResources().getString(R.string.menu_share_business_card));
    ...
    private void openDeleteDialog(String id) {
        ...
        btnYes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                alertDialog.cancel();
                presenter.gsonsharecarddelete(id);
            }
        });
